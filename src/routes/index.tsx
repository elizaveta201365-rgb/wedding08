...
function Index() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#f7f6f1] text-[#3d4a37] overflow-hidden relative font-serif">
      ...
      <section className="relative mx-auto max-w-6xl px-5 sm:px-6 md:px-10 pt-14 sm:pt-16 md:pt-20 pb-4 sm:pb-5 md:pb-6 min-h-screen flex items-center">
      ...
      <section className="relative mx-auto max-w-6xl px-4 sm:px-6 md:px-10 pt-8 sm:pt-10 md:pt-12 pb-6 sm:pb-10 md:pb-12">
        <div className="text-center mb-10 sm:mb-14 animate-fade-up">
          ...
          <p className="font-sans text-[12px] sm:text-sm text-[#6b7f5c] mt-2 px-2 leading-relaxed">
            Для всех желающих мы готовы организовать трансфер с Комендантского проспекта.
          </p>
        </div>
      ...
      {/* Расписание */}
      <section className="relative mx-auto max-w-6xl px-5 sm:px-6 md:px-10 pt-8 sm:pt-10 md:pt-12 pb-8 sm:pb-10 md:pb-12">
        <div className="text-center mb-10 sm:mb-14 animate-fade-up">
          <div className="flex items-center justify-center gap-3 mb-5 text-[#6b7f5c]">
            <span className="block h-px w-10 sm:w-14 bg-[#8ba173]" />
            <span className="font-serif italic text-3xl sm:text-4xl md:text-5xl text-[#2d3d2a] leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 items-center max-w-4xl mx-auto">
          <div className="animate-fade-up order-1">
            ...
            <p className="font-serif italic text-[15px] sm:text-[16px] leading-[1.8] sm:leading-[1.9] text-[#7ACD7A] font-semibold">
              Так как мы будем на берегу залива, просим вас взять с собой удобную обувь для выхода на пляж. Мы точно будем там фотографироваться <span className="not-italic">😉</span>
            </p>
          </div>
